...
class Database:
    ...
    def create_table_addresses(self):
        sql = '''
    ...
    def insert_addresses(self, name, price, info):
        sql = '''INSERT INTO addresses(name, price, info) VALUES (?, ?, ?)'''
        self.execute(sql, name, price, info, commit=True)